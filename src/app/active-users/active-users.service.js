(function() {
  ...
  function ActiveUsers($http, $q, APP_CONFIG) {
    ...
    function getDailyActiveUsersData(dataContainer, startDate, endDate, deviceFilter, roleFilter, activityCount, reversedContainerCb) {
      var deferred = $q.defer(),
          query = createQueryString('1d', startDate, endDate, deviceFilter, roleFilter);
  ...
  ActiveUsers.$inject = ['$http', '$q', 'APP_CONFIG'];

  angular.module('dataDashboard.activeUsers.service.ActiveUsers', [])
