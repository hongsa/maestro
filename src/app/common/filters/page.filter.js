(function () {
  ...
  function pageNameFilter() {
    return function (input) {
      if (pageName[input] && input.length >2 && pageName[input].length !== 0) {
  ...
  angular.module('dataDashboard.common.filter.pageName', []).filter('pageName', pageNameFilter);
}());
