(function () {
  ...
  function BarchartUtils(APP_CONFIG) {
    return {
      ...
      BarChartConfig2: BarChartConfig2
    };
    ...
    function BarChartConfig2(dataSeries, func, tooltipShared, dateFormat, stackingOpt) {
      this.options = {
        chart: {type: 'column'},
        tooltip: {
          xDateFormat: dateFormat || '%A, %B %d, %Y',
  ...
  angular.module('maestro.common.utils.BarchartUtils', []).factory('BarchartUtils', BarchartUtils);
}());