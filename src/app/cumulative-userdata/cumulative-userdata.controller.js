(function () {
  ...
  function CumulativeUserDataController(CumulativeUserData, LinechartUtils, PiechartUtils, APP_CONFIG, $filter, CSVparserUtils) {
    ...
    vm.lineChartData = [vm.cumulativeUserDataForLineChart];
    ...
    function lineChartFilter() {
      CumulativeUserData.getCumulativeUserData(vm.cumulativeUserDataForLineChart, vm.selectedRange, vm.selectedPaidFilter, vm.dateRange.startDate, vm.dateRange.endDate).then(function (result) {
  ...
  CumulativeUserDataController.$inject = [
    'CumulativeUserData',
    'LinechartUtils',
    'PiechartUtils',
    'APP_CONFIG',
  ...
  angular.module('dataDashboard.cumulativeUserData.controller.CumulativeUserDataController', []).controller('CumulativeUserDataController', CumulativeUserDataController);
}());