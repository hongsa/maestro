(function () {
  ...
  function CumulativeUserDataRouter($stateProvider) {
    $stateProvider.state('dashboard.cumulativeUserData', {
  ...
  angular.module('dataDashboard.cumulativeUserData.CumulativeUserDataRouter', []).config(CumulativeUserDataRouter);
}());