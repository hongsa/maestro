(function() {
  ...
  function CustomQueryController(CustomQuery, LinechartUtils, APP_CONFIG) {
    ...
    vm.availableAPIs = ['users', 'classes', 'posts', 'sessions', 'notices', 'photos', 'albums', 'search'];
    vm.availableMethods = ['GET', 'POST', 'PUT', 'DELETE'];
    ...
    vm.availableGroupBys = ['date', 'role', 'device', 'country', 'method'];
    vm.availableChartTypes = ['line', 'area', 'bar', 'column', 'pie', 'scatter'];
    ...
    function updateCustomQueryString() {
      vm.customQueryString = CustomQuery.createQueryString(vm.selectedAPIFilter,
                                                           vm.selectedDeviceFilter,
                                                           vm.selectedRoleFilter,
                                                           vm.selectedCountryFilter,
                                                           vm.selectedMethodFilter,
  ...
  CustomQueryController.$inject = ['CustomQuery', 'LinechartUtils', 'APP_CONFIG'];
