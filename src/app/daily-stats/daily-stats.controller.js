(function() {
  ...
  function DailyStatsController(DailyStats, $timeout) {
    var vm = this,
        ...
        target,
        classStatsUpdateBtn,
        mobileStatsUpdateBtn,
        userStatsUpdateBtn,
        visitsStatsUpdateBtn,
        alertMsg,
    ...
    function updateData() {
      ...
      DailyStats.getRoleProportionData(vm.pieChartData,
                                       vm.selectedPieSubject,
  ...
  DailyStatsController.$inject = ['DailyStats', '$timeout'];

  angular.module('dataDashboard.dailyStats.controller.DailyStatsController', [])
