(function() {
  ...
  function DailyStats($http, $q, APP_CONFIG) {
    ...
    function getDailyStatsData(dataContainer, dataSubject, startDate, endDate, deviceFilter, roleFilter, countryFilter, chart) {
      var deferred = $q.defer(),
          query = createQueryString(dataSubject, startDate, endDate, deviceFilter, roleFilter, countryFilter, 'linechart');
    ...
    function getRoleProportionData(dataContainer, dataSubject, startDate, endDate, chart, alertCb) {
      var deferred = $q.defer(),
          query = createQueryString(dataSubject, startDate, endDate, 'All', 'All', 'All', 'role'),
  ...
  DailyStats.$inject = ['$http', '$q', 'APP_CONFIG'];

  angular.module('dataDashboard.dailyStats.service.DailyStats', [])
    .factory('DailyStats', DailyStats);
})();
