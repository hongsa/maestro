(function() {
  ...
  function VisitsStatsController(DailyStats, ActiveUsers, LinechartUtils, CSVparserUtils, APP_CONFIG) {
    ...
    vm.availableRoles = ['all', 'student', 'teacher', 'parent'];
    vm.availableDevices = ['all', 'android', 'ios', 'web'];
    vm.availableCountries = ['all', 'kr', 'jp', 'us', 'tw', 'ca'];
    ...
    function updateData() {
      ...
      ActiveUsers.getDailyActiveUsersData(vm.visits,
    ...
    function fetchAndDownloadCSV() {
      CSVparserUtils.downloadCSV(vm.visits,
                                 false,
                                 'daily_visits_' +
  ...
  VisitsStatsController.$inject = ['DailyStats', 'ActiveUsers', 'LinechartUtils', 'CSVparserUtils', 'APP_CONFIG'];

  angular.module('dataDashboard.dailyStats.controller.VisitsStatsController', [])
    .controller('VisitsStatsController', VisitsStatsController);
})();