(function() {
  ...
  AndroidCountryStatsController.$inject = ['MobileStoreStats', 'LinechartUtils', 'CSVparserUtils', 'CommonUtils', 'APP_CONFIG', '$scope'];

  angular.module('dataDashboard.mobileStoreStats.controller.AndroidCountryStatsController', [])
    .controller('AndroidCountryStatsController', AndroidCountryStatsController);
})();