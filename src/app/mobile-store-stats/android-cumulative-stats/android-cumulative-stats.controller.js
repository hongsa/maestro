(function () {
  ...
  AndroidCumulativeStatsController.$inject = [
    'MobileStoreStats',
    'LinechartUtils',
    'CSVparserUtils',
    'APP_CONFIG',
  ...
  angular.module('dataDashboard.mobileStoreStats.controller.AndroidCumulativeStatsController', []).controller('AndroidCumulativeStatsController', AndroidCumulativeStatsController);
}());