(function() {
  ...
  AndroidDailyDeviceStatsController.$inject = ['MobileStoreStats', 'LinechartUtils', 'CSVparserUtils', 'APP_CONFIG', '$scope'];

  angular.module('dataDashboard.mobileStoreStats.controller.AndroidDailyDeviceStatsController', [])
    .controller('AndroidDailyDeviceStatsController', AndroidDailyDeviceStatsController);
})();