(function() {
  ...
  AndroidDailyUserStatsController.$inject = ['MobileStoreStats', 'LinechartUtils', 'CSVparserUtils', 'APP_CONFIG', '$scope'];

  angular.module('dataDashboard.mobileStoreStats.controller.AndroidDailyUserStatsController', [])
    .controller('AndroidDailyUserStatsController', AndroidDailyUserStatsController);
})();