(function () {
  ...
  AndroidLanguageStatsController.$inject = [
    'MobileStoreStats',
    'LinechartUtils',
    'CSVparserUtils',
    'CommonUtils',
  ...
  angular.module('dataDashboard.mobileStoreStats.controller.AndroidLanguageStatsController', []).controller('AndroidLanguageStatsController', AndroidLanguageStatsController);
}());