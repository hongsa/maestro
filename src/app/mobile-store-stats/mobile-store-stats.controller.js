(function() {
  ...
  function MobileStoreStatsController(MobileStoreStats, LinechartUtils, CSVparserUtils, $timeout) {
    var vm = this,
        refDate = new Date(),
        minimumYear = 2015,
        defaultYear = refDate.getMonth() === 0 ? refDate.getFullYear()-1 : refDate.getFullYear(),
        androidDailyDeviceStatsUpdateBtn,
        androidDailyUserStatsUpdateBtn,
        androidCumulativeStatsUpdateBtn,
        androidLanguageStatsUpdateBtn,
        androidCountryStatsUpdateBtn;

    vm.availableMonths = ['01','02','03','04','05','06','07','08','09','10','11','12'];
    vm.availableYears = [];
    vm.monthNames = {
  ...
  MobileStoreStatsController.$inject = ['MobileStoreStats', 'LinechartUtils', 'CSVparserUtils', '$timeout'];

  angular.module('dataDashboard.mobileStoreStats.controller.MobileStoreStatsController', [])
    .controller('MobileStoreStatsController', MobileStoreStatsController);
})();