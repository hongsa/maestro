(function() {
  ...
  MobileStoreStats.$inject = ['$http', '$q', 'APP_CONFIG', 'CSVparserUtils'];

  angular.module('dataDashboard.mobileStoreStats.service.MobileStoreStats', [])
    .factory('MobileStoreStats', MobileStoreStats);
})();
