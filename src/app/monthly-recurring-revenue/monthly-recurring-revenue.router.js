(function () {
  ...
  function MonthlyRecurringRevenueRouter($stateProvider) {
    $stateProvider.state('dashboard.monthlyRecurringRevenue', {
  ...
  angular.module('dataDashboard.monthlyRecurringRevenue.MonthlyRecurringRevenueRouter', []).config(MonthlyRecurringRevenueRouter);
}());