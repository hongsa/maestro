(function() {
  ...
  function SigninService($http, $q, $cookies, $rootScope, APP_CONFIG) {
    ...
    function signin(data) {
      ...
      $http({
        ...
        $cookies.session_token = result.data.session_id; // DSP 2.0: result.data.session_token;
  ...
  SigninService.$inject = ['$http', '$q', '$cookies', '$rootScope', 'APP_CONFIG'];

  angular.module('dataDashboard.signin.service.SigninService', ['ngCookies'])
