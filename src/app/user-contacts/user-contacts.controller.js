(function () {
  ...
  function UserContactsController(UserContacts) {
    ...
    function fetchAndDownloadCSV(subject) {
      UserContacts.fetchAndDownloadActiveTeachersContacts(subject, vm.selectedYearFilter, vm.selectedMonthFilter, vm.selectedCountryFilter);
    }
  }
  UserContactsController.$inject = ['UserContacts'];
  angular.module('dataDashboard.userContacts.controller.UserContactsController', []).controller('UserContactsController', UserContactsController);
}());